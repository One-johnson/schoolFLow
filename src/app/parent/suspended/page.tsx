...
export default function ParentSuspendedPage(): React.ReactNode {
  return (
      ...
      <Card className="border-amber-200/70 bg-amber-500/[0.04] shadow-sm dark:border-amber-900/45 dark:bg-amber-500/[0.06]">
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          <p>
            ...
            subscription). The parent portal is locked until the school is reactivated.
          </p>
          <p>Please contact your school office for support.</p>
          <div className="flex flex-wrap gap-2">
            <Button asChild variant="outline">
              <Link href="/parent/login">Go to login</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
