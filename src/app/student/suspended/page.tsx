...
export default function StudentSuspendedPage(): React.ReactNode {
  return (
      ...
      <Card className="border-amber-200/70 bg-amber-500/[0.04] shadow-sm dark:border-amber-900/45 dark:bg-amber-500/[0.06]">
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          <p>
            ...
            subscription). The student portal is locked until the school is reactivated.
          </p>
          <p>
            Please contact your school office or administrator for help. If you were in the middle
            of something, you can try again later.
          </p>
