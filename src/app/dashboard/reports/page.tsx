...
import { Calendar as CalendarIcon, FileDown, Printer, Loader2 } from "lucide-react"
...
export default function ReportsPage() {
  ...
  const allAttendanceData = React.useMemo<FullAttendanceLog[]>(() => {
    ...
    setLoading(false);
    return flatData;
  }, [rawAttendance, studentsMap, classesMap, attendanceLoading, studentsLoading, classesLoading]);
