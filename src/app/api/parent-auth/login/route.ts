...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    const parentWithStudents = await convex.query(api.parents.getParentWithStudents, {
      parentId: parent._id,
    });
    const students = parentWithStudents?.students ?? [];
    ...
    await ParentSessionManager.setSessionCookie(sessionToken);
